...
): e is MouseEvent => (e as MouseEvent).button !== undefined;
export const isTouchEvent = (
	e:
		...
		| Event
		| MouseEvent<HTMLDivElement, MouseEvent>
): e is TouchEvent => (e as TouchEvent).touches !== undefined;
export const isPointerEvent = (
	e:
		| MouseEvent
		| TouchEvent
		| PointerEvent
...
BoulderMarker2.displayName = "BoulderMarker";
