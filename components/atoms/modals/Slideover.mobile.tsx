...
export const SlideoverMobile: React.FC<SlideoverMobileProps> = ({
  ...
  function handleTouchEnd(e: React.TouchEvent<HTMLDivElement>) {
    ...
    if (Math.abs(start - end) > 50) {
      ...
      } else if (!persistent || translateY > MINIMIZED) { // CLOSE
  ...
  return (
    <div
      className={`flex flex-col ${dragging ? '' : 'transition ease-in-out'} absolute w-full bg-white rounded-t-lg h-[100%] pb-[7%] mb-[5%] z-500 shadow`}
