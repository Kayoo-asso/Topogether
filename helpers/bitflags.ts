...
export const hasFlag = <T extends Bitflag>(value: T | undefined, flag: T): boolean =>
	(value! & flag) === flag;

export const hasSomeFlags = <T extends Bitflag>(value: T | undefined, flags: T): boolean =>
	(value! & flags) !== 0;

export const toggleFlag = <T extends Bitflag>(value: T | undefined, flag: T): T =>
	(value! ^ flag) as T;

export const setFlag = <T extends Bitflag>(value: T | undefined, flag: T): T =>
	(value! | flag) as T;

export const unsetFlag = <T extends Bitflag>(value: T | undefined, flag: T): T =>
	(value! & ~flag) as T;
