...
export const hasSomeFlags = <T extends Bitflag>(value: T | undefined, flags: T): boolean => (value! & flags) !== 0;
...
export const mergeFlags =  <T extends Bitflag>(flags: T[]): T => flags.reduce((m, flag) => (m | flag) as T, 0 as T);
