...
export type MapProps = MapEventHandlers &
...
// (this is an isomorphism proof)
// These two functions are the proof.
function _markerHandlersIsomorphismForward(
	handler: MarkerEventHandlerName
): keyof MarkerEventHandlers {
	return handler;
}

function _markerHandlersIsomorphismBackward(
	handler: keyof MarkerEventHandlers
): MarkerEventHandlerName {
	return handler;
}
...
// (this is an isomorphism proof)
// These two functions are the proof.
function _polygonHandlersIsomorphismForward(
	handler: PolygonEventHandlerName
): keyof PolygonEventHandlers {
	return handler;
}

function _polygonHandlersIsomorphismBackward(
	handler: keyof PolygonEventHandlers
): PolygonEventHandlerName {
	return handler;
}
...
function _polylineHandlersIsomorphismForward(
	handler: PolylineEventHandlerName
): keyof PolylineEventHandlers {
	return handler;
}

function _polylineHandlersIsomorphismBackward(
	handler: keyof PolylineEventHandlers
): PolylineEventHandlerName {
	return handler;
}
