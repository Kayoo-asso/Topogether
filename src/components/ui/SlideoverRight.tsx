...
export const SlideoverRight: React.FC<SlideoverRightProps> = ({
	open = false,
	secondary = false,
	...props
}: SlideoverRightProps) => {
	...
	return (
		<div
			className={classNames(
				"absolute top-0 flex h-full w-[300px] flex-col border-l border-grey-medium bg-white",
...
SlideoverRight.displayName = "SlideoverRightDesktop";
