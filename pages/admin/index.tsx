    ...
    <>
      ...
      <div className="h-full flex flex-row bg-white">
          ...
          <div className='w-full h-[10%] mt-[10%]'>
            <Tabs 
              tabs={[
                { iconName: 'edit', iconStroke: true, color: 'second', action: () => setTopoToDisplay(TopoStatus.Draft)},
                { iconName: 'recent', iconStroke: true, color: 'third', action: () => setTopoToDisplay(TopoStatus.Submitted)},
                { iconName: 'checked', iconFill: true, color: 'main', action: () => setTopoToDisplay(TopoStatus.Validated)},
              ]}
            />
          </div>
